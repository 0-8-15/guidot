...
(guide-style-declare highlight-color: default: #f pred: #f doc: "Color for highlights")
(guide-style-declare background-highlight-color: default: #f pred: #f doc: "Color for highlighted background")
;;
